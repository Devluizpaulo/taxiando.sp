...
import { createCreditPackage } from '@/app/actions/billing-actions';
        ...
        try {
            ...
            if (result.success) {
                toast({
                    ...
                    description: `O pacote "${values.name}" foi salvo.`,
                });
            ...
            toast({
                ...
                description: (error as Error).message || 'Não foi possível salvar o pacote. Tente novamente.',
            });
        } finally {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-8">
                <div>
                    <h1 className="font-headline text-3xl font-bold tracking-tight">Criar Pacote de Créditos</h1>
                    <p className="text-muted-foreground">Defina os detalhes do novo pacote de créditos para venda.</p>
                </div>
