...
import { getAllPartners, updatePartnerStatus, deletePartner } from '@/app/actions/marketing-actions';
                            ...
                            {partners.length === 0 ? (
                                ...
                                <TableRow key={partner.id}>
                                    <TableCell className="font-medium flex items-center gap-3">
                                        <Image src={partner.imageUrl} alt={partner.name} width={64} height={32} className="rounded-md object-contain bg-muted p-1" />
