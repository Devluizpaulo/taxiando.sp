...
export function PartnerForm({ partner }: { partner?: Partner }) {
    ...
    const imagePreview = localPreview || watchedImageUrl;
                                    ...
                                    <TabsContent value="upload" className="pt-4">
                                     ...
                                     <TabsContent value="gallery" className="pt-4">
                                        ...
                                        {galleryImages.map(img => (
                                            <button type="button" key={img.id} className={cn("relative aspect-square rounded-md overflow-hidden focus:ring-2 focus:ring-ring ring-offset-2", watchedImageUrl === img.url && "ring-2 ring-ring")} onClick={() => {
