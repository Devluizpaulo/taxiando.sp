                ...
                <TabsContent value="users" className="mt-6 space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Total de {userReports.totalUsers} usuários cadastrados.</CardDescription>
                        </CardHeader>
                     ...
                     <Card>
                        ...
                        <CardContent>
                            <Table>
                                ...
                                <TableBody>
                                    {userReports.topRatedDrivers.map(driver => (
                     ...
                     <Card>
                        ...
                        <CardContent>
                             <Table>
                                ...
                                <TableBody>
                                    {financialReports.packages.map(pkg => (
                                        <TableRow key={pkg.id}>
                     ...
                     <Card>
                        ...
                        <CardContent>
                             <Table>
                                ...
                                <TableBody>
                                    {financialReports.topUsedCoupons.map(coupon => (
                      ...
                      <Card>
                        ...
                        <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                            <div className="p-4 bg-muted rounded-lg">
                                ...
                                <p className="text-3xl font-bold">{engagementReports.totalVehicles}</p>
                            </div>
                             <div className="p-4 bg-muted rounded-lg">
                                <p className="text-sm text-muted-foreground">Veículos Alugados</p>
                                <p className="text-3xl font-bold">{engagementReports.rentedVehicles}</p>
                            </div>
                             <div className="p-4 bg-muted rounded-lg">
                                <p className="text-sm text-muted-foreground">Total de Candidaturas</p>
                                <p className="text-3xl font-bold">{engagementReports.totalApplications}</p>
                            </div>
                        </CardContent>
                    </Card>
                     <Card>
                        ...
                        <CardContent>
                             <Table>
                                ...
                                <TableBody>
                                    {engagementReports.topCourses.map(course => (
