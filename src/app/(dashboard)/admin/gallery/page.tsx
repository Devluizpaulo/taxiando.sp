...
import { getGalleryImages, uploadToGallery, deleteGalleryImage, updateGalleryImage } from '@/app/actions/gallery-actions';
...
function ImageUploadDialog({ onUploadFinished }: { onUploadFinished: () => void }) {
    ...
    const onSubmit = async (values: ImageFormValues) => {
        ...
        try {
            ...
            const galleryResult = await uploadToGallery({
