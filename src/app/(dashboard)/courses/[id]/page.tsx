    ...
    modules: [
        {
            ...
            lessons: [
                { id: 'l1-1', title: "O Código de Trânsito Brasileiro (CTB)", type: "video", duration: 15, isCompleted: true },
        ...
        },
        {
            ...
            lessons: [
                { id: 'l3-1', title: "Tipos de Infração (Leve, Média, Grave, Gravíssima)", type: "video", duration: 15, isCompleted: false },
                                    ...
                                    <AccordionContent>
                                        <ul className="space-y-4 pt-2">
                                            {module.lessons.map(lesson => (
                                                <li key={lesson.id} className="flex items-center justify-between rounded-md p-3 hover:bg-muted/50">
