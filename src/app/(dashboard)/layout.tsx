                    ...
                    <SidebarGroup>
                        ...
                        <SidebarGroupContent>
                            <SidebarMenu>
                                ...
                                <SidebarMenuItem onClick={handleMenuClick}><SidebarMenuButton asChild><Link href="/admin/dicas"><Star className="text-amber-500" /> Dicas</Link></SidebarMenuButton></SidebarMenuItem>
