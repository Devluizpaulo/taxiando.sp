...
const roles: { id: Role; title: string; description: string; icon: React.ElementType }[] = [
    { id: 'driver', title: 'Motorista', description: 'Acesse seu painel pessoal e oportunidades.', icon: Car },
    { id: 'fleet', title: 'Frota', description: 'Gerencie seus veículos e motoristas.', icon: Building },
    { id: 'provider', title: 'Prestador', description: 'Gerencie seus serviços e anúncios.', icon: Wrench },
];
            ...
            {roles.map((role) => (
                 <Card 
                    ...
                    className={cn(
                        ...
                        selectedRole && selectedRole !== role.id && "opacity-50 hover:opacity-100"
                    )}
                 >
