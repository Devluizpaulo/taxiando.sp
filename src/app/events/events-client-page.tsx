                ...
                <div className="container mx-auto px-4 py-12 md:px-6 md:py-16">
                    <div className="mb-12 text-center slide-in">
                     ...
                     <Tabs defaultValue="events" className="w-full slide-in">
                        <TabsList className="grid w-full grid-cols-3 h-16 bg-gradient-to-r from-slate-100 via-gray-50 to-zinc-100 p-1 rounded-2xl shadow-xl border border-slate-200/50">
                            <TabsTrigger 
                                value="events" 
                            ...
                            <TabsTrigger 
                                value="driver_tips" 
                                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-slate-600 data-[state=active]:to-gray-700 data-[state=active]:text-white data-[state=active]:shadow-xl data-[state=active]:scale-105 transition-all duration-500 rounded-xl font-semibold text-base flex items-center gap-2 group hover:bg-slate-50 hover:text-slate-700 hover:scale-102"
                            >
                                <div className="relative">
                                    <Car className="h-5 w-5 group-data-[state=active]:animate-pulse" />
                                    <div className="absolute -top-1 -right-1 w-2 h-2 bg-slate-500 rounded-full opacity-0 group-data-[state=active]:opacity-100 group-data-[state=active]:bg-white"></div>
                                </div>
                                <span>Para Você, Motorista</span>
                            </TabsTrigger>
                            <TabsTrigger 
                                value="client_tips" 
                                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-500 data-[state=active]:to-teal-600 data-[state=active]:text-white data-[state=active]:shadow-xl data-[state=active]:scale-105 transition-all duration-500 rounded-xl font-semibold text-base flex items-center gap-2 group hover:bg-emerald-50 hover:text-emerald-700 hover:scale-102"
                            >
                                <div className="relative">
                                    <Users className="h-5 w-5 group-data-[state=active]:animate-pulse" />
                                    <div className="absolute -top-1 -right-1 w-2 h-2 bg-emerald-500 rounded-full opacity-0 group-data-[state=active]:opacity-100 group-data-[state=active]:bg-white"></div>
                                </div>
                                <span>Para seu Cliente</span>
                            </TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="driver_tips" className="mt-8 slide-in">
                             {driverTips.length > 0 ? (
                                 <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                                    {driverTips.map((tip, index) => (
                                        <div key={tip.id} className="slide-in" style={{ animationDelay: `${index * 50}ms` }}>
                                            <CityTipCard tip={tip} />
                                        </div>
                                    ))}
                                 </div>
                             ) : (
                                 <Card className="py-16 text-center slide-in">
                                    <CardHeader>
                                        <Compass className="mx-auto mb-4 h-12 w-12 text-slate-400" />
                                        <CardTitle className="text-slate-700">Nenhuma Dica Cadastrada</CardTitle>
                                        <CardDescription className="text-slate-500">Estamos preparando as melhores dicas para você. Volte em breve!</CardDescription>
                                    </CardHeader>
                                </Card>
                             )}
                        </TabsContent>

                         <TabsContent value="client_tips" className="mt-8 slide-in">
                             {clientTips.length > 0 ? (
                                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                                    {clientTips.map((tip, index) => (
                                        <div key={tip.id} className="slide-in" style={{ animationDelay: `${index * 50}ms` }}>
                                            <CityTipCard tip={tip} />
                                        </div>
                                    ))}
                                  ...
                                  <Card className="py-16 text-center slide-in">
                                    <CardHeader>
                                        <Compass className="mx-auto mb-4 h-12 w-12 text-slate-400" />
                                        <CardTitle className="text-slate-700">Nenhuma Dica Cadastrada</CardTitle>
                                        <CardDescription className="text-slate-500">Estamos preparando as melhores sugestões para seus clientes. Volte em breve!</CardDescription>
                                    </CardHeader>
                                </Card>
                             )}
                        </TabsContent>
