                            ...
                            {featuredServices.map((srv) => (
                                <Card key={srv.id} className="flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                                    <CardHeader className="p-0">
                                        <Image src={srv.imageUrl || 'https://placehold.co/600x400.png'} alt={srv.title} width={600} height={400} className="aspect-video w-full object-cover" data-ai-hint="services marketplace"/>
                                    </CardHeader>
                                    <CardContent className="flex-1 p-4">
