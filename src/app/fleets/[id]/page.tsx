            ...
            <main className="flex-1">
                ...
                <div className="container mx-auto -mt-24 px-4 md:px-6">
                    <div className="flex flex-col items-center gap-4 text-center md:flex-row md:items-end md:text-left">
                        <div className="relative h-36 w-36 flex-shrink-0 rounded-full border-4 border-background bg-card shadow-lg">
                            <Image src={fleet.photoUrl || 'https://placehold.co/200x200.png'} alt={`Logo da ${fleet.nomeFantasia || fleet.name}`} layout="fill" objectFit="cover" className="rounded-full" data-ai-hint="company logo"/>
                        </div>
